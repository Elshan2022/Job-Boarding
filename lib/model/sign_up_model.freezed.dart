...
class _$SignUpModelImpl implements _SignUpModel {
  ...
  @override
  String toString() {
    return 'SignUpModel(uuid: $uuid, name: $name, surname: $surname, email: $email, phoneNumber: $phoneNumber, password: $password)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, uuid, name, surname, email, phoneNumber, password);
